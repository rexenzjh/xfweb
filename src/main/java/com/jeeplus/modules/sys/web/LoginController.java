...
public class LoginController extends BaseController{
	...
	@RequiresPermissions("sys:watchIndex:view")
	@RequestMapping(value = "${adminPath}/watchIndex")
	public String login_index(HttpServletRequest request, HttpServletResponse response, Model model){
		return "modules/echarts/main";
	}
