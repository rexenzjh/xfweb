...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" style="height:64px;width:64px;" src="<c:if test="${fns:getUser().photo != null and fns:getUser().photo != '' }">
                            ${fns:getUser().photo } </c:if><c:if test="${fns:getUser().photo == '' }">
                                   ${ctxStatic}/images/userinfo.jpg </c:if> " /></span>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                        ...
                        <li class="dropdown">
							...
							<ul class="head-list dropdown-menu with-arrow">
								<li>
									...
									<a class="lang-select">
										<img class="lang-flag" src="${ctxStatic}/common/img/china.png" alt="中国">
										<span class="lang-id"><a href="${ctx}/watchIndex">中国</a></span>
										<span class="lang-name">中文</span>
									</a>
								</li>
								<li>
            ...
            <div class="footer">
                <div class="pull-left"><a href="http://www.rexen.com.cn">http://www.rexen.com.cn</a> &copy; 2017 V1.0.0</div>
            </div>
        </div>
        <!--右侧部分结束-->
