    ...
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            <td class="width-15 active">
                <label class="pull-right"><font color="red">*</font>归属栏目：</label>
            </td>
            <td class="width-35">
            ...
            <td class="width-15 active">
                <label class="pull-right">外部链接：</label>
            </td>
            <td class="width-35">
        ...
        <tr>
            ...
            <td class="width-15 active">
                <label class="pull-right">颜色：</label>
            </td>
            <td class="width-35">
        ...
        <tr id="linkBody" style="display:none">
        ...
        <tr>
            <td class="width-15 active">
                <label class="pull-right">关键字：</label>
            </td>
            <td class="width-35">
